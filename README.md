...
https://atmos.tools/deprecated/github-actions/atmos-get-setting for the equivalent built-in
commands (`atmos list settings --query` / `atmos describe component --query`) and how to move your workflow over.
